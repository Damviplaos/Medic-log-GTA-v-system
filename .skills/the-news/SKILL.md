...
| Endpoint | Method | URL |
|----------|--------|-----|
| Top Stories | GET | `https://app-culx9wchdc75-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top` |
| All News | GET | `https://app-culx9wchdc75-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all` |
| Similar News | GET | `https://app-culx9wchdc75-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}` |
| News by UUID | GET | `https://app-culx9wchdc75-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/{uuid}` |
| Sources | GET | `https://app-culx9wchdc75-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources` |

Base host: `app-culx9wchdc75-api-wL1zlEdVM6DY.gateway.appmedo.com`
