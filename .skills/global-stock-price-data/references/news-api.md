...
**Endpoint:** `GET https://app-culx9wchdc75-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-culx9wchdc75-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
